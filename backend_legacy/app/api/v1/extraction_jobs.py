...
from app.pipeline.orchestrator import can_run_real_pipeline, run_real_extraction
from app.repo.jobs import ActiveExtractionJobExistsError, create_job, get_job_by_public_id
...
async def create_extraction_job(
    ...
    """Create an extraction job row and start extraction pipeline."""
    ...
    try:
        ...
        raise HTTPException(
            status_code=409,
            detail={
                "message": "Extraction job already running for this set",
                "activeJobId": exc.active_job_public_id,
            },
        ) from exc
