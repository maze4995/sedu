...
CREATE TABLE sets (
    ...
    status          TEXT NOT NULL DEFAULT 'created',  -- created | extracting | ready | needs_review | error
    title           TEXT,
    file_name       TEXT,
...
CREATE TABLE questions (
    ...
    metadata            JSONB NOT NULL DEFAULT '{}',  -- unit, difficulty, tags, source_page, question_bbox …

    confidence          REAL,
    review_status       TEXT NOT NULL DEFAULT 'pending', -- unreviewed | auto_ok | auto_flagged | approved | rejected
...
CREATE INDEX idx_question_variants_qid ON question_variants (question_id, created_at DESC);
